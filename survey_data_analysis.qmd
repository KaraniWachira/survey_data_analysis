...
#### what if we want to create a statistical summary table to estimate their financial wellbeing score abbreviated by FWBscore in the refence document where a higher score denotes more satisfaction with the finances and a lower score denotes the vice versa.
...
lets improve our visualization further buy having a grouped bar plot by working on the annual financial income 
...
ggplot(summ_stat_tbl, aes(x = gen_small_house, y = average_FWBscore_weighted, fill = PPINCIMP)) +
  ...
  labs(
    x = " ",
    y = "average financial wellbing score", fill = "Household income"
  ) +
  theme_light()
